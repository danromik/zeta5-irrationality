/-
cert/C3Scan.lean — module-keyed environment scan (certification of 2026-09-23; report in
...
Run from the repository root, after `lake build` (about 10 minutes):
  lake env lean cert/C3Scan.lean
Expected output: cert/c3/C3Scan.out.
-/
import Zeta5
